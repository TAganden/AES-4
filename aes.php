...
if (is_ajax()) {
	if (isset($_POST["inputText"]) && !empty($_POST["inputText"])) { //Checks if action value exists
			...
			if (isset($_POST["inputKey"]) && !empty($_POST["inputKey"])) { //Checks if action value exists
			  
				if (isset($_POST["blockSize"]) && !empty($_POST["blockSize"])) { //Checks if action value exists
					
					if (isset($_POST["encdec"]) && !empty($_POST["encdec"])) { //Checks if action value exists
